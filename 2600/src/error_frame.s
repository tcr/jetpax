;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
; Source: http://8bitworkshop.com/v3.3.0/?=&file=examples%2Ftinyfonts2&platform=vcs
;
...
ErrLoopCount	.byte ; counts scanline when drawing
StrPtr		    .word ; pointer to text string
StrLen		    .byte ; counts chars when building string
ErrTempSP	    .byte ; temp. storage for stack pointer
...
DrawText subroutine
    ...
    sta ErrLoopCount
BigLoop
	ldy ErrLoopCount	; counts backwards
    ...
    ldy ErrTemp	; load B5 -> Y
    sta GRP1	; B3 -> [GRP1]; B2 -> GRP0
    stx GRP0	; B4 -> [GRP0]; B3 -> GRP1
    sty GRP1	; B5 -> [GRP1]; B4 -> GRP0
    sta GRP0	; ?? -> [GRP0]; B5 -> GRP1
    dec ErrLoopCount	; go to next line
