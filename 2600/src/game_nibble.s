...
.op_start:
    NIBBLE_RAM cmp, NibbleX
    bne .op_else
    lda #BC_STX
    rts
.op_else:
    NIBBLE_RAM cmp, NibbleY
    bne .op_end
    lda #BC_STY
    rts
.op_end:
